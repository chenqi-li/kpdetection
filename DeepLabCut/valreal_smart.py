...
if __name__ == '__main__':
    ...
    #parser.add_argument('--run_dir', default='sim01_run01-chenqi-2022-07-22', type=str) #Unused, to use: uncomment os.path.join(root_dir,args.run_dir) and comment for folder loop
    ...
    # run_dir = os.path.join(root_dir,run_dir) #os.path.join(root_dir,args.run_dir)
    ...
    if not os.path.exists(os.path.join(root_dir,run_dir_real)):
        ...
        if os.path.exists(os.path.join(root_dir,run_dir_real,'evaluation-results')):
            shutil.rmtree(os.path.join(root_dir,run_dir_real,'evaluation-results'))
        if os.path.exists(os.path.join(root_dir,run_dir_real,'labeled-data')):
            shutil.rmtree(os.path.join(root_dir,run_dir_real,'labeled-data'))
        os.makedirs(os.path.join(root_dir,run_dir_real,'labeled-data'))
        if os.path.exists(os.path.join(root_dir,run_dir_real,'training-datasets')):
